...
latesth5 ="/home/microralp/mk_dev/ReSort-IT/mask_rcnn/logs/instrumentsegm20210212T1855/mask_rcnn_instrumentsegm_0280.h5"
...
test_image_path = "/home/microralp/mk_dev/ReSort-IT/lab_data/inst_scanning_4/imgL/"
...
def test_images(test_image_path):
    ...
    test_path = "/home/microralp/mk_dev/ReSort-IT/lab_data/dataset"
    ...
    for file in image_files: 
        ...
        if len(r['class_ids'])!=0:
            ...
            plt.imsave( test_path +'/imgs/' + 'inst4L' + str(nums) +  msk_str +'.png', img) 
            plt.imsave(test_path + '/msks/' + 'inst4L' + str(nums) + msk_str + "mask" +'.png',  np.array(mask).reshape(img_arr.shape[0],img_arr.shape[1]), cmap=cm.gray)  
            visualize.display_instances(img, r['rois'], r['masks'], r['class_ids'], class_names, r['scores'], figsize=(5,5))
            nums -=1
        else:
