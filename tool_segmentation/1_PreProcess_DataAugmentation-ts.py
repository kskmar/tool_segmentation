...
for n in range(len(image_paths)):
    ...
    # cv2.imwrite('/home/microralp/tests/synthImgs/' +  f_str + "XXmask" +'.png', mask)  
    ...
    cv2.imwrite('/home/microralp/tests/synthImgs/' +  f_str + '.png', img3) 
