...
class InstrumentSegmConfig(Config):
    ...
    RPN_ANCHOR_SCALES = (16, 32, 64, 128, 256)   #(4, 8, 16, 32, 64)  (32, 64, 128, 256, 320!!!)
    TRAIN_ROIS_PER_IMAGE = 128 #128 #256 #128  #32
    MAX_GT_INSTANCES = 1
...
# path_json_val = '/home/microralp/mk_dev/robot-surgery-segmentation/data/maskrcnn_datasetD/annot/trainFulldatasetD.json'  
# path_images_val = "/home/microralp/mk_dev/robot-surgery-segmentation/data/maskrcnn_datasetD/train"

path_json_train = '/home/microralp/mk_dev/ReSort-IT/lab_data/datasetMin/annot/annotdatasetMin.json'   
path_images_train = "/home/microralp/mk_dev/ReSort-IT/lab_data/datasetMin/train"    
dataset_train = CocoLikeDataset()
dataset_train.load_data(path_json_train, path_images_train )
dataset_train.prepare()

path_json_val = '/home/microralp/mk_dev/ReSort-IT/lab_data/datasetMin/annot/annotdatasetMin.json'  
path_images_val = "/home/microralp/mk_dev/ReSort-IT/lab_data/datasetMin/train"
...
model.train(dataset_train, dataset_val, 
            ...
            imgaug.augmenters.Affine(rotate=(-45, 45)), 
            imgaug.augmenters.Affine(rotate=(-90, 90)),
            imgaug.augmenters.Affine(scale=(0.6, 1.4))]))
